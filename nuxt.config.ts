...
export default defineNuxtConfig({
  ...
  i18n: {
    ...
    locales: [
      { code: "uz", file: "uz/uz-UZ.json", language: "O'zbekcha" },
      { code: "kril", file: "uz_cyr/cr-CR.json", language: "Ўзбекча" },
      { code: "ru", file: "ru/ru-RU.json", language: "Русский" },
      { code: "en", file: "en/en-EN.json", language: "English" },
    ],
    defaultLocale: "uz",
  },
